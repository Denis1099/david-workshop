...
import SeminarGrid from '../../src/components/seminars/SeminarGrid';
import { generateSeminarSlug } from '../../src/utils/seminarUtils';
          ...
          <div className="mx-auto px-4 max-w-[1200px]">
            <div className="bg-gray-800 rounded-lg p-8 text-center">
              ...
              <p className="typo-body-regular text-gray-300 mb-8">
                אתם מוזמנים לרשום לי הודעה בוואטסאפ או לקרוא עוד עלי
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button 
                  onClick={() => router.push('/about-david')}
