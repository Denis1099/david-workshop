...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[70vh] lg:min-h-[92vh] overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-10 min-h-[60vh] sm:min-h-[70vh] lg:min-h-[92vh] flex items-center justify-center">
        <div className="container-mobile w-full">
          <div className="flex flex-col items-center text-center" dir="ltr">
            {/* Main Content - Centered */}
            <div className="text-center" dir="rtl">
              {/* Main Headline */}
              <h1 className="typo-page-title leading-tight mb-6 sm:mb-8 text-white px-2">
                הסדנה <span className="underline decoration-cta decoration-2 sm:decoration-4 
                                      underline-offset-2 sm:underline-offset-4">היחידה</span> בארץ 
                שתלמד
                <br className="hidden xs:block" />
                <span className="block xs:inline"> אותך לשלוט בהרמת משקולות</span>
                <br className="hidden xs:block" />
                <span className="block xs:inline"> בביטחון מלא ובטכניקה נכונה.</span>
              </h1>

              {/* Subheadline */}
              <div className="mb-12 sm:mb-16 lg:mb-20 px-2">
                <p className="typo-body-large-wrapped text-gray-100 leading-relaxed max-w-3xl mx-auto">
                  שלום, אני דוד ליטבינוב - ספורטאי אולימפי ושיאן ישראל
                  <br className="hidden sm:block" />
                  <span className="block sm:inline"> אני מזמין אותך לסדנה שלי שתשנה לך את הטכניקה לתמיד.</span>
                </p>
              </div>

              {/* CTA Buttons */}
              <div className="flex flex-col xs:flex-row gap-4 sm:gap-6 justify-center 
                              items-center mb-8 sm:mb-12 px-4">
                {/* Primary CTA */}
                <button className="w-full xs:w-auto bg-cta hover:bg-yellow-600 text-bg-primary 
                ...
                <button 
                  ...
                  className="w-full xs:w-auto bg-transparent border-2 border-white 
                            text-white hover:bg-white 
                            hover:text-bg-primary typo-button-regular 
                            btn-mobile-optimized
                            flex items-center justify-center gap-3 transform hover:scale-105 shadow-lg"
                >
                  ליצירת קשר
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:gap-8 justify-center px-4">
