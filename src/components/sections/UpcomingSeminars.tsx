    ...
    <section id="upcoming" 
      ...
      <div className="mx-auto px-4 max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 
          ...
          {seminars.map((seminar) => (
            <div key={seminar.id} 
              ...
              <div className="bg-gradient-to-br from-cta to-yellow-600 p-6 
                              text-center">
                <div className="w-16 h-16 bg-white rounded-full flex 
                               items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-cta" fill="currentColor" 
                       viewBox="0 0 20 20">
              ...
              <div className="p-6 text-center">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-center gap-2 
                                 mb-2">
                    <svg className="w-5 h-5 text-cta" fill="currentColor" 
                         viewBox="0 0 20 20">
                      <path fillRule="evenodd" 
                ...
                {/* CTA Button */}
                <button className="w-full bg-cta hover:bg-yellow-600 
        ...
        <div className="text-center">
          <p className="typo-body-large-wrapped text-gray-600 mb-6">
            לא רואים תאריך שמתאים לכם?
          </p>
          <button className="bg-gray-800 hover:bg-gray-700 text-white 
                            typo-button-regular px-8 py-4 rounded-lg 
                            transition-colors">
            ליצירת קשר לתיאום תאריך אישי
          </button>
        </div>
      </div>
    </section>
